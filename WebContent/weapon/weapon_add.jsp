        ...
        <div class="wp-wrapper" style="height: 920px;">
            <div class="wp-inner clearfix" style="height: 920px;">
                ...
                <div class="news clearfix">
                    <div frag="添加武器信息模块"style="color:#eee;" class="font">
                     	<form action="../weapon_addServlet" style="text-align: center;" method="post">
                     		型号：<input type="text" name="model"><br>
                     		名称：<input type="text" name="name"><br>
                     		口径：<input type="text" name="caliber"><br>
                     		类型：<input type="text" name="type"><br>
                     		种类：<input type="text" name="variety"><br>
                     		路径：<input type="text" name="route"><br>
                     		详情：<textarea name="detail" clos="25" rows="8"></textarea><br>
                     		<c:if test="${not empty error_input}">
								<span style="color:#ff0000">** ${error_input}**</span><br>
							</c:if>
                     		<input type="submit" value="确认">
                     		<input type="reset" value="重置">
                     		<a style="color:#ff0000" href="../index.jsp">返回</a><br>
                     	</form>
                    </div>
                </div>
            </div>
